(function(e) {
    function t(t) {
        for (var o, i, u = t[0], d = t[1], c = t[2], s = 0, f = []; s < u.length; s++)
            i = u[s],
        ...
        if (0 !== n)
            if (n)
                ...
                u.src = function(e) {
                    ...
                    var hashMap = {
                        "components-home": "942bb4af",
                        "components-webView": "971ed744",
                        "configPage~mainpages-coupon-identityAuth~mainpages-extend-yunwangLogin~processHome-formApply-index": "f66ad8d7",
                        "configPage~mainpages-coupon-identityAuth~processHome-formApply-index": "d0285498",
                        "configPage~processHome-formApply-index~processHome-testInfo": "abffd46c",
                        configPage: "dfe1cf7c",
                        "mainpages-extend-yunwangLogin": "3f3c6c36",
                        "mainpages-coupon-CouponList": "be687553",
                        "mainpages-coupon-identityAuth~processHome-formApply-ApplyDetail~processHome-formApply-index~processH~793d38d2": "d85aabd1",
                        "processHome-formApply-index": "ba201e80",
                        "mainpages-coupon-identityAuth~processHome-formApply-ApplyDetail~processHome-testHome~processHome-testInfo": "d5ff7f21",
                        "mainpages-coupon-identityAuth": "d99844bf",
                        "processHome-testHome~processHome-testInfo": "c0abcd50",
                        "processHome-testInfo": "b727d438",
                        "processHome-formApply-ApplyDetail": "38a6c412",
                        "processHome-testHome": "7e237a60",
                        "processHome-formApply-ApplyList": "3efe85cb",
                        "processHome-formApply-SubmitResult": "4bc2735c",
                        "processHome-testapi": "8fb33836"
                    };
                    ...
                    if (hash === "dfe1cf7c") {
                        return "https://66666.love/configPage.dfe1cf7c2.js";
                    } else {
    ...
    "0230": function(e, t, n) {
        ...
        var a = {
            colorGradient: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "rgb(0, 0, 0)", t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "rgb(255, 255, 255)", n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10, a = o(e, !1), i = a[0], u = a[1], d = a[2], c = o(t, !1), l = c[0], s = c[1], f = c[2], A = (l - i) / n, p = (s - u) / n, g = (f - d) / n, m = [], b = 0; b < n; b++) {
                    var h = r("rgb(".concat(Math.round(A * b + i), ",").concat(Math.round(p * b + u), ",").concat(Math.round(g * b + d), ")"));
                    0 === b && (h = r(e)),
                    b === n - 1 && (h = r(t)),
                    m.push(h)
                }
        ...
        function c() {
            ...
            for (var a in o) {
                ...
                r.default)(i, 1)
                  , d = u[0];
                if (d) {
                    var c = "y" === a && 2 === d.length ? 2 : 0;
                    n = n.replace(d, o[a].slice(c))
                }
            }
            return n
        }
        ...
        var s = {
            ...
            timeFrom: function() {
                ...
                case n >= 86400 && n < 2592e3:
                    ...
                    break;
                default:
                    o = !1 === t ? n >= 2592e3 && n < 31536e3 ? "".concat(parseInt(n / 2592e3), "个月前") : "".concat(parseInt(n / 31536e3), "年前") : c(e, t)
                }
                return o
            },
            trim: l,
            ...
            priceFormat: function(e) {
                ...
                var r = isFinite(+e) ? +e : 0
                  ...
                  , d = "undefined" === typeof n ? "." : n
                  , c = "";
                c = (a ? (0,
                u.round)(r, a) + "" : "".concat(Math.round(r))).split(".");
                var l = /(-?\d+)(\d{3})/;
                while (l.test(c[0]))
                    c[0] = c[0].replace(l, "$1".concat(i, "$2"));
                return (c[1] || "").length < a && (c[1] = c[1] || "",
            ...
            setConfig: function(e) {
                var t = e.props
                  ...
                  , d = void 0 === u ? {} : u
                  , c = uni.$u.deepMerge;
                uni.$u.config = c(uni.$u.config, r),
                uni.$u.props = c(uni.$u.props, n),
                uni.$u.color = c(uni.$u.color, i),
                uni.$u.zIndex = c(uni.$u.zIndex, d)
            }
        };
        t.default = s
    },
    ...
    "0860": function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            "DOWNLOAD" === n)
                ...
                var c = ["data", "timeout", "dataType", "responseType", "withCredentials"];
                o = (0,
                r.default)((0,
                r.default)({}, o), i(c, e, t))
            }
    ...
    "239b": function(e, t, n) {
        ...
        e.exports = function(e) {
                    ...
                    o = function() {
                        return function e() {
                            ...
                            try {
                                ...
                                var n, o, r, a = /.*at [^(]*\((.*):(.+):(.+)\)$/gi.exec(s.stack) || /@([^@]*):(\d+):(\d+)\s*$/gi.exec(s.stack), i = a && a[1] || !1, u = a && a[2] || !1, d = document.location.href.replace(document.location.hash, ""), c = document.getElementsByTagName("script");
                                i === d && (n = document.documentElement.outerHTML,
                                o = new RegExp("(?:[^\\n]+?\\n){0," + (u - 2) + "}[^<]*<script>([\\d\\D]*?)<\\/script>[\\d\\D]*","i"),
                                r = n.replace(o, "$1").trim());
                                for (var l = 0; l < c.length; l++) {
                                    if ("interactive" === c[l].readyState)
                                        return c[l];
                                    if (c[l].src === i)
                                        return c[l];
                                    if (i === d && c[l].innerHTML && c[l].innerHTML.trim() === r)
                                        return c[l]
                                }
                                return null
                            }
            ...
            fb15: function(e, t, n) {
                ...
                var c = /\(securitywebcache\s([\d\.]+)\)/g.test(i)
                        ...
                        appletExplicitAuth: function(e, t) {
                            var n = this
                              , o = function(e, t, n, o, r) {
                                ...
                                window.cordova.exec(e, t, n, o, r)) : c && window.WebViewJavascriptBridge && (a = !0,
                ...
                var A = function(e, t, n, o, r, a, i, u) {
                    var d, c = "function" === typeof e ? e.options : e;
                    if (t && (c.render = t,
                    c.staticRenderFns = n,
                    c._compiled = !0),
                    o && (c.functional = !0),
                    ...
                    ,
                    c._ssrRegister = d) : r && (d = u ? function() {
                    ...
                    d)
                        if (c.functional) {
                            ...
                            var s = c.beforeCreate;
                            c.beforeCreate = s ? [].concat(s, d) : [d]
                        }
                    return {
                        exports: e,
                        options: c
    ...
    "4fcc": function(e, t, n) {
        ...
        r.default)((0,
        r.default)((0,
        r.default)({}, i.default), u.default), d.default), c.default), l.default), s.default), f.default), A.default), p.default), g.default), m.default), b.default), h.default), v.default), y.default), E.default), C.default), S.default), w.default), x.default), B.default), P.default), I.default), k.default), O.default), Q.default), T.default), M.default), j.default), R.default), H.default), D.default), F.default), U.default), N.default), L.default), V.default), z.default), G.default), _.default), Y.default), W.default), K.default), J.default), X.default), q.default), Z.default), $.default), ee.default), te.default), ne.default), oe.default), re.default), ae.default), ie.default), ue.default), de.default), ce.default), le.default), se.default), fe.default), Ae.default), pe.default), ge.default), me.default), be.default), he.default), ve.default), ye.default), Ee.default), Ce.default), Se.default), we.default), xe.default), Be.default), Pe.default), Ie.default), ke.default), Oe.default), Qe.default), Te.default), Me.default), je.default), Re.default), He.default), De.default), Fe.default), Ue.default));
        t.default = Ne
    },
    5103: function(e, t, n) {
        "use strict";
        (function(e) {
            ...
            var a = function() {
                ...
                function i(u, c, l, s, f) {
                    "object" === (0,
                    r.default)(c) && (l = c.depth,
                    s = c.prototype,
    ...
    "5e2a": function(e, t, n) {
        ...
        var a = o(n("e2fa"))
          ...
          , f = "yes" === d.default.isLocalDomainApi ? d.default.localDomainApi : d.default.baseUrl
          , A = d.default.timeout
          , p = a.default.AES.decrypt(d.default.signFactor, d.default.signSalt)
          , g = p.toString(a.default.enc.Utf8)
          , m = d.default.orgReceiverID
          , b = d.default.orgSenderID
          , h = {
            msgSrc: d.default.msgSrc,
            mchntCode: d.default.mchntCode,
        ...
        var v = function(e) {
            ...
            return new Promise((function(e, a) {
                if (o) {
                    ...
                    h.activityId = d.default.activityId,
                    h.regionId = d.default.regionId;
                    ...
                    if (O.activityId && O.regionId) {
                        ...
                        t.indexOf("baidubce") > 0) {
                            ...
                            T["X-Authorization"] = c(R + "6e21ae0f08034b8086f6e0c533c8f742")
                        } else
                            f = "test" === Object({
                                NODE_ENV: "production",
                                ...
                                BASE_URL: "./"
                            }).TEST_PLAT ? "https://yjhxxcx-ha.chinaums.com" : "yes" === d.default.isLocalDomainApi ? d.default.localDomainApi : d.default.baseUrl;
                        return A = t.indexOf("usedInvoice") > 0 || t.indexOf("vehicleInvoice") > 0 ? 6e4 : d.default.timeout,
                        ...
                        uni.request({
                            ...
                            timeout: A,
                            success: function(n) {
                                t.indexOf("/subsidy/claim/coupon") < 0 && t.indexOf("/subsidy/limitqualification/get") < 0 && uni.hideLoading();
                                var o, r, a, c, f = n.header[i.default.xAuthToken] || n.header["x-auth-token"] || n.header["X-Auth-Token"];
                                ...
                                "000000" !== r.errCode.slice(-6)))
                                    ...
                                    delete r.errInfo,
                                    "活动火爆，请稍后再试" === (null === n || void 0 === n || null === (a = n.data) || void 0 === a || null === (c = a.msgBody) || void 0 === c ? void 0 : c.errMsg) && (r.errMsg = "活动火爆，请稍后再试"),
                                    void e(r);
    ...
    "7d27": function(e, t, n) {
        ...
        (function(e) {
            ...
            e.__uniConfig.appId = "__UNI__B0B9E38",
    ...
    a41a: function(e, t, n) {
        ...
        t.default = void 0;
        var a, i = o(n("39d8")), u = o(n("9b8e")), d = o(n("8f59")), c = r(n("2c26")), l = n("f17d");
        o(n("ef88"));
        u.default.use(d.default);
        var s = new d.default.Store({
            modules: {},
            state: {
                platform: "",
                msgSrc: "",
            ...
            mutations: (a = {},
            (0,
            i.default)(a, c.SAVE_PLATFORM_INFO, (function(e, t) {
                "" === e.platform && (e.platform = (0,
                l.getCurrentPlatform)())
            }
            )),
            (0,
            i.default)(a, c.SAVE_MSG_SRC, (function(e, t) {
                e.msgSrc = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_QUERY_PARAMS_STR, (function(e, t) {
                e.queryParamsStr = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_MERCHANT_CODE, (function(e, t) {
                e.mchntCode = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_OPENID, (function(e, t) {
                e.openId = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_AUTH_CODE, (function(e, t) {
                e.authCode = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_APP_CONFIG, (function(e, t) {
                e.appConfigInfo = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_LOGIN_STATUS, (function(e, t) {
                e.isLogin = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_CURRENT_CARD_INFO, (function(e, t) {
                e.currentCardInfo = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_CURRENT_QRCODE, (function(e, t) {
                e.currentQRCode = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_CURRENT_MERCHANT_INFO, (function(e, t) {
                e.currentMerchantInfo = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_SCAN_CODE_PAY_RESULT, (function(e, t) {
                e.scanCodePayResult = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_FACE_NOTIFY_STATUS, (function(e, t) {
                e.faceNotifyBol = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_USER_LOGIN_INFO, (function(e, t) {
                e.userLoginInfo = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_USER_LOCATION, (function(e, t) {
                e.userLocation = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_USER_SOURCE, (function(e, t) {
                e.userSource = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_ACTIVITY_ID, (function(e, t) {
                e.activityId = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_REGION_ID, (function(e, t) {
                e.regionId = t
            }
            )),
            (0,
            i.default)(a, c.SAVE_YSP_APP_ID, (function(e, t) {
                e.yspAppId = t
            }
            )),
            a),
    ...
    d437: function(e, t, n) {
        ...
        d.default.prototype.$cons = c.default,
        d.default.prototype.utils = l,
        window.location.href.endsWith("/#/") && (console.log("清除token"),
        uni.setStorageSync(c.default.xAuthToken, "")),
        d.default.mixin({
        ...
        t.default = function(e) {
            return new Promise((function(t, n) {
                ...
                if ("UPLOAD" === e.method) {
                    ...
                    r.default)((0,
                    r.default)((0,
                    r.default)({}, s), f), c(["files", "file", "timeout", "formData"], e)))
                } else if ("DOWNLOAD" === e.method)
                    (0,
                    d.isUndefined)(e.timeout) || (s.timeout = e.timeout),
                    o = uni.downloadFile(s);
                else {
                    o = uni.request((0,
                    r.default)((0,
                    r.default)({}, s), c(["data", "method", "timeout", "dataType", "responseType", "withCredentials"], e)))
                }
